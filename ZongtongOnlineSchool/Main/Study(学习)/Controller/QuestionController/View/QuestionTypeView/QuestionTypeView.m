...
@implementation QuestionTypeView
...
{
    if ([self.qTypeViewDelegate respondsToSelector:@selector(qTypeViewTimerClicked)]) {
        [self.qTypeViewDelegate qTypeViewTimerClicked];
    }
}
