...
- (UISegmentedControl *)segmentedControl{
    if (!_segmentedControl) {
        _segmentedControl = [[UISegmentedControl alloc] initWithItems:@[@"0.75X",@"1.0X",@"1.25X",@"1.5X",@"2.0X"]];
...
- (void)layoutSubviews{
    ...
    self.downLoadBtn.frame = CGRectMake(30, 30, 60, 60);
    
    [self.downLoadBtn setImage:[UIImage imageNamed:@"avcDownload"] forState:UIControlStateNormal];
    [self.downLoadBtn setTitle:@"下载" forState:UIControlStateNormal];
    self.downLoadBtn.titleLabel.font = [UIFont systemFontOfSize:12.0f];
    CGFloat offset = 10.0f;
    self.downLoadBtn.titleEdgeInsets = UIEdgeInsetsMake(0, -self.downLoadBtn.imageView.frame.size.width, -self.downLoadBtn.imageView.frame.size.height-offset/2, 0);
    self.downLoadBtn.imageEdgeInsets = UIEdgeInsetsMake(-self.downLoadBtn.titleLabel.intrinsicContentSize.height-offset/2, 0, 0, -self.downLoadBtn.titleLabel.intrinsicContentSize.width);
    ...
    _playLineView.frame = CGRectMake(0, CGRectGetMaxY(self.downLoadBtn.frame)+20, containsViewWidth, 1);
...
//                       NSLocalizedStringFromTableInBundle(@"speed rate", nil, resourceBundle, nil)];
    NSString *title = [NSString stringWithFormat:@"速度已切换至 %@",speedStr];
