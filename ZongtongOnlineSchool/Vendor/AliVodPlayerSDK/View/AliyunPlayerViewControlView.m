...
- (void)setIslive:(BOOL)isLive {
    [self.topView.downloadButton removeFromSuperview];
    if (isLive) {
        [self.topView.downloadButton removeFromSuperview];
        [self.bottomView.leftTimeLabel removeFromSuperview];
        [self.bottomView.rightTimeLabel removeFromSuperview];
        [self.bottomView.fullScreenTimeLabel removeFromSuperview];
        [self.bottomView.progressView removeFromSuperview];
    }
}
