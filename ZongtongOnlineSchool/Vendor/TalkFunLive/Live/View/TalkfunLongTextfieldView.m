...
//    self.tf.attributedPlaceholder = [[NSAttributedString alloc] initWithString:@"我要聊天..." attributes:@{NSForegroundColorAttributeName:[UIColor whiteColor]}];
    [self.tf setValue:[[UIColor whiteColor] colorWithAlphaComponent:0.5] forKeyPath:@"_placeholderLabel.textColor"];
}
