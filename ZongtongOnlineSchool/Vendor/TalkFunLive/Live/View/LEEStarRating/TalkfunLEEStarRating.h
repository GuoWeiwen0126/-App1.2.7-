...
@interface TalkfunLEEStarRating : UIView

@property (nonatomic , assign ) CGFloat height;//默认高度
...
/**
 当前分数变更Block
 */
@property (nonatomic , copy ) void (^currentScoreChangeBlock)(CGFloat urrentScoreChange,NSInteger tag);
